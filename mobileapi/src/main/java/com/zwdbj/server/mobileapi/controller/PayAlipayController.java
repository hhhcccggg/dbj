...
public class PayAlipayController {
    ...
    public ResponseData<ChargeCoinAlipayResult> payOrder(@RequestBody PayOrderInput input) {
        ServiceStatusInfo<ChargeCoinAlipayResult> serviceStatusInfo = this.alipayBizService.payOrder(input,JWTUtil.getCurrentId());
        if (serviceStatusInfo.isSuccess()) {
            return new ResponseData<>(ResponseDataCode.STATUS_NORMAL,"OK",serviceStatusInfo.getData());
        }
        return new ResponseData<>(ResponseDataCode.STATUS_ERROR,serviceStatusInfo.getMsg(),null);
    ...
    public ResponseData<AliOrderQueryResult> orderQuery(@RequestBody AliOrderQueryInput input) {
        ServiceStatusInfo<AliOrderQueryResult> serviceStatusInfo = this.alipayBizService.orderQuery(input,1);
        if (serviceStatusInfo.isSuccess()) {
            return new ResponseData<>(ResponseDataCode.STATUS_NORMAL,"OK",serviceStatusInfo.getData());
        }
        return new ResponseData<>(ResponseDataCode.STATUS_ERROR,serviceStatusInfo.getMsg(),null);
    ...
    public void payNotify(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        ServiceStatusInfo<Object> serviceStatusInfo = this.alipayBizService.paramsRsaCheckV1(params,1);
        if (serviceStatusInfo.isSuccess()) {
