...
public class OperateService {
    ...
    public String getNickName(int length){
        String gg = "天,地,玄,黄,宇,宙,洪,荒,日,月,盈,昃,辰,宿,列,张,寒,来,暑,往,秋,收,冬,藏,闰,馀,成,岁,律,吕,调,阳,云," +
                ...
                "场,化,被,草,木,赖,及,万,方,盖,此,身,发,四,大,五,常,恭,惟,鞠,养,岂,敢,女,慕,贞,洁,男,效,才,良,知," +
                ...
                "貌,辨,色,贻,厥,嘉,猷,勉,其,祗,植,省,躬,讥,诫,宠,增,抗,极,殆,近,林,皋,幸,即,两,疏,见,机,解,组,谁," +
                ...
                "妙,毛,施,淑,姿,工,妍,笑,年,矢,每,催,曦,晖,朗,曜,璇玑,悬,晦,庄,徘,徊,语,助,者";
