...
public class ExceptionController {
    ...
    public ResponseData handle401(ShiroException e) {
        return new ResponseData<String>(ResponseDataCode.STATUS_UNAUTH, e.getMessage(), null);
    }
    ...
    public ResponseData handle401() {
        return new ResponseData<String>(ResponseDataCode.STATUS_UNAUTH, "Unauthorized", null);
    }
    ...
    public ResponseData globalException(HttpServletRequest request, Throwable ex) {
        return new ResponseData<String>(getStatus(request).value(), ex.getMessage(), null);
    }
